...
static QObject* sysmonSingletonFactory(QQmlEngine*, QJSEngine*) { return new SysmonProvider(); }

static QObject* nixgenSingletonFactory(QQmlEngine*, QJSEngine*) { return new NixGenProvider(); }

static QObject* polkitAgentFactory(QQmlEngine*, QJSEngine*) { return new PolkitAgent(); }

static QObject* hwProviderFactory(QQmlEngine*, QJSEngine*) { return new HwProvider(); }

static QObject* systemdWatcherFactory(QQmlEngine*, QJSEngine*) { return new SystemdWatcher(); }
